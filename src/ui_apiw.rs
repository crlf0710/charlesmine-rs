...
impl Ui {
    ...
    fn call_open_file_dialog(parent: &UiWindow, filter_res_id: usize, default_ext: &str) -> Option<PathBuf> {
        //FIXME: filter.
    ...
    fn call_save_file_dialog(parent: &UiWindow, filter_res_id: usize, default_ext: &str) -> Option<PathBuf> {
        //FIXME: filter.
        SaveFileDialogBuilder::new()
            .parent(parent)
            .default_extension(default_ext)
            .flags(SaveFileDialogFlags::SHOW_HELP |
                        ...
                        resources::IDM_FILE_GAME_EASY | resources::IDM_FILE_GAME_MEDIUM | resources::IDM_FILE_GAME_HARD => {
                            THE_GAME.with(|game| {
                                ...
                                let boardsetting = match args.id() as isize {
                                    ...
                                    resources::IDM_FILE_GAME_MEDIUM => model_config::BoardSetting::NORMAL,
                                    resources::IDM_FILE_GAME_HARD => model_config::BoardSetting::HARD,
                                    _ => unreachable!()
                                };
                                game.mvc.process_input(ControllerInput::ModelCommand(
